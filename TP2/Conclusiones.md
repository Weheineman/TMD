...
# Ejercicio 1
Todo el código está en `1`. Los archivos R imprimen los datasets en un `.csv` así los puedo levantar con `pandas`. `prepare_crabs.py` hace una transformación logarítmica del dataset y luego aplica PCA.  Los demás scripts utilizados tienen el nombre del método que utilizan.
